...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center  relative py-12 sm:px-6 lg:px-8">
      <Link
        className="absolute top-0 left-0 bg-yellow-500 px-3 py-2 rounded-sm"
        to={"/"}
      >
        Back To Home
      </Link>
